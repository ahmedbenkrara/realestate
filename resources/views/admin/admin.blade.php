...
@section('title')
{{__('login.feats').' | '.\App\Http\Controllers\SettingsController::settings()->title}}
@endsection
    ...
    <div class="main">
        <div class="form">
            ...
            <form action="/admin" method="POST">
                ...
                <label for="password">{{ __('login.confirmp') }} :</label>
                <input type="password" placeholder="{{ __('login.confirmp') }}" id="password" class="input" name="password_confirmation">
                <button type="submit"  class="register">{{ __('login.crt') }}</button>
            </form>
        </div>
    </div>
@endsection